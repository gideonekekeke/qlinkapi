...
const { validateUsers, validateSignIn } = require("../ValidationFile/ValidateUser");
...
const RegisterDeveloper = async (req,res) =>{
  try{
    ...
    const {name, email, avatar, jobTitle, salary, age, experience, phoneNumber,
    websiteUrl,
    description,
    gender,
    location,
  ...
  const {name, email, avatar, jobTitle, salary, age, experience, phoneNumber,
    ...
    // if(checker){
      ...
      // const Image = await cloudinary.uploader.upload(req.file.path)
        ...
        const EditData = await userData.findByIdAndUpdate(req.params.id,{
              name,
       email, 
      // avatar : Image.secure_url,
      //  avatarID : Image.public_id,
